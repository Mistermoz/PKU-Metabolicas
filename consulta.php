...
$dbh = new wpdb( 'u346567244_admin', '123metabolicas', 'u346567244_consulta', 'mysql.1freehosting.com');
if($nom_paciente)
{
  $query = "SELECT * FROM paciente WHERE Nombre='".$nom_paciente."' AND F_lectura='".$fecha_paciente."'";
  ...
  $nom_archivo = 'Ficha-'.$nom_paciente.'-'.$fecha_paciente;
}
// Add some data
