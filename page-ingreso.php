      ...
      <div id="post-&lt;?php the_ID(); ?&gt;" <?php post_class(); ?>>
        <div class="post-entry">
		  ...
		  <div class="box_nom_campos">
			...
			<label class="nom_campo nom_campo--leu" id="leu">Leu</label>
		  ...
		  <div class="box_inputs">
			<div id="registro1" class="registro registro1" rel="1">
			  ...
			  <input type="text" name="leu1" class="leu nom_campo--leu" value="" placeholder="Leu" />
    ...
    <script>
		...
		function ingreso_paciente(){
			...
			jQuery.ajax({
				...
				cache: true,
				data:
				{'action':'ingreso_pacientes', 'rut_paciente': rut_paciente, 'nom_paciente' : nom_paciente, 'flectura' : flectura, 'fenil' : fenil, 'tir' : tir, 'leu' :leu, 'fmuestra' : fmuestra},
				url: url_ajax,
				dataType: "json",
				beforeSend: function () {
		...
		function agregar_paciente(){
			var c = jQuery(".box_inputs > .registro").length;
			c = c+1;
			jQuery('.box_inputs').append('<div id="registro'+c+'" class="registro registro'+c+'" rel="'+c+'"><div class="numero"><label class="nro_paciente">'+c+'.</label><input type="checkbox" class="nro" name="nro'+c+'" value=""/></div><div id="box_paciente'+c+'" class="box_paciente box_paciente'+c+'"><label class="elige_paciente">Rut</label><input type="radio" id="rut" name="paciente" value="0" rel="'+c+'"/><label class="elige_paciente">Nombre</label><input type="radio" id="nombre" name="paciente" value="1" rel="'+c+'"/></div><div class="rut nom_campo--rut_nom"><input type="text" class="input_rut_nom" name="rut_nom'+c+'" value=""/></div><input type="text" name="flectura'+c+'" class="flectura fecha" value="" placeholder="Ej:dd-mm-aaaa" /><input type="text" name="fenil'+c+'" class="fenil" value="" placeholder="Fenil" /><input type="text" name="leu'+c+'" class="leu" value="" placeholder="Leu" /><input type="text" name="tiro'+c+'" class="tiro" value="" placeholder="Tir" /><input type="text" name="fmuestra'+c+'" class="fmuestra fecha" value="" placeholder="Ej:dd-mm-aaaa" /></div>');
			jQuery( ".fecha" ).datepicker({
			    changeMonth: true,
			    changeYear: true,
			    dateFormat: 'dd-mm-yy',
